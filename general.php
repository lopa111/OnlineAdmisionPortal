...
<HTML>
    ...
    <body>
        ...
        <div class="applicationform">
            <form id="applicationform" method="post" action="gen_next.php" enctype="multipart/form-data">
            <label for="course" id="course"><b>Course :</b></label>
            <select name="course" >
                <option>Choose Course</option>
                <option>B.Sc General(Pure Science)</option>
                <option>B.Sc General(Bio Science)</option>
                <option>BA general</option>
                <option>BA(Major)Communicative English</option>
                <option>BA(Major)Travel and Tourism</option>
            </select><br><br>
            ...
            <input type="text"name="glname"id="name"placeholder="Last name">

            <label for="relation"><b>Guardian relation :</b></label>
            <select name="relation"id="blood">
            ...
            <input type="string"name="gnum"id="num"placeholder="Guardian's Contact Number"maxlength="10"><br>
            <br><center> <h8>Academic details-<br></h8> </center>
            <label for="classx"style="font-size:20px;"><b>Class X :</b></label><BR><br>
                ...
                <select name="yearp"id="num">
                    <option name="nine">2019</option>
                    <option name="eight">2018</option>
                    <option name="seven">2017</option>
                    <option name="six">2016</option>
                    <option name="five">2015</option>
                </select><br><br>
