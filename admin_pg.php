<?php
   ...
   <head>
       ...
       <title>PG application details</title>
       <style>
           .my{
   ...
   <body> 
       <?php
       $query= "SELECT * FROM pgregistration ";
                 ...
                 <table border="2">
                      <tr>
                         ...
                         <th class="my">Delete</th>
                          ...
                          <th class="my">University</th>
                          <th class="my">College Name</th>
                          <th class="my">year(Graduation)</th>
                          <th class="my">Percentage(Graduation)</th>
                     ...
                     ?>
                     <tr>
                     <?php echo "<td><a href=\"edit1.php?id=$result[app_no]\" >Edit</a>" ?>
                     <?php echo "<td><a href=\"delete1.php?id=$result[app_no]\">Delete</a>" ?>
                     ...
                     <td><?php echo $result['yearc']; ?></td>
                     <td><?php echo $result['marksavgc']; ?></td>
